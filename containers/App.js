...
class App extends Component {
    ...
    componentDidMount() {
        ...
        this.props.setupGrid(window.innerWidth, window.innerHeight, imageSize, minRowMargin, gutterWidth);
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        setupGrid: (width, height, largeImageSize, largeMarginX, largeGutterWidth, smallImageScaleFactor) => {
            dispatch(setupGrid(width, height, largeImageSize, largeMarginX, largeGutterWidth, smallImageScaleFactor));
        }
    };
};
